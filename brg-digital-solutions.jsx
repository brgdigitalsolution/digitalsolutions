...
// and resolve through CSS variables set in the App root (see <style> block).
const C = {
  navy: "#140A24",
  navyDeep: "#0D0718",
  indigo: "#2E1065",
...
const QUIZ_RECOMMENDATIONS = {
  "travel-ecom": "web", "travel-seo": "seo", "travel-brand": "web", "travel-ai": "ai",
  "institution-ecom": "web", "institution-seo": "seo", "institution-brand": "web", "institution-ai": "ai",
  "local-ecom": "ecom", "local-seo": "seo", "local-brand": "web", "local-ai": "ai",
  "startup-ecom": "ecom", "startup-seo": "seo", "startup-brand": "web", "startup-ai": "ai",
};
...
/* ============================= AI CHATBOT ============================= */
const CHAT_SYSTEM_PROMPT = `You are the website assistant for BRG Digital Solutions, a digital agency in New Delhi, India (brgdigitalsolutions.com, +91 98114 19910, brgdigitalsolutions@gmail.com, B-158/159 Sainik Nagar, New Delhi – 110059).
...
function ChatWidget({ open, setOpen }) {
  ...
  const send = async () => {
    ...
    try {
      ...
      const reply = data?.content?.find((c) => c.type === "text")?.text || "Sorry, I couldn't process that — please try again or reach us on WhatsApp.";
...
export default function App() {
  ...
  const setPage = (id) => {
    setPageState(id);
    if (typeof window !== "undefined") window.location.hash = id === "home" ? "" : id;
  };
